  ...
  return (
    ...
    <header className="border-b bg-white sticky top-0 z-50 overflow-x-clip">
      <div className="max-w-6xl mx-auto px-3 sm:px-4">
        ...
        {/* Row 2: SP (< sm) 専用のサブナビ。
            Row 1 の右端が招待/通知/ユーザー/ログアウトで埋まって「アーティスト検索」
            「案件検索」が入らないため、SP のみ横並び 2 段目にする。
            sm 以上は Row 1 の中央ナビが担うので非表示。 */}
        <nav className="sm:hidden border-t border-purple-100 flex items-center gap-2 -mx-3 px-3 py-2 overflow-x-auto">
          <Link
            href="/artists"
            className="inline-flex items-center gap-1.5 shrink-0 font-semibold text-purple-700 bg-purple-50 hover:bg-purple-100 border border-purple-200/70 px-3 py-1.5 rounded-lg transition-colors text-xs whitespace-nowrap"
          >
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
              <circle cx="11" cy="11" r="7" />
              <path d="M21 21l-4.35-4.35" />
