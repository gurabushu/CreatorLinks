...
const FAQS = [
  {
    ...
    a: '長年組んでる仲間との仕事は LINE で十分だと思います。EncoreCue が効くのは (1) 初対面・知り合いの知り合いとの案件で「先払い→踏み倒し」のリスクを消したいとき、(2) 副業ミュージシャンが確定申告で LINE トークを掘り返す作業から解放されたいとき、(3) 業界内の見知らぬ人からも仕事が来る「名刺代わりのプロフィール」が欲しいとき、の 3 シーンです。手数料 7% は「サービス料」ではなく「未払い保険料 + 集客費」として設計しています。',
  },
  {
    q: '手数料 7% は他と比べて高い？安い？',
    a: 'クラウドソーシングの中では最安クラスです（ランサーズ 16.5%、クラウドワークス 20%、ココナラ 22%）。ただし LINE + 銀行振込は 0% です。EncoreCue の 7% は Stripe エスクロー・記録保管・業界内での発見性・レビュー実績の蓄積とセットの価値です。踏み倒し 1 件（¥30k-100k）を回避できれば元が取れます。',
  },
  {
