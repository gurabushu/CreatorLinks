...
// 事業者は TobojoLabs（個人事業主・代表 沖山敦樹）、管轄は東京地方裁判所。変更時はここを更新する。
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <p className="text-sm text-gray-700 mb-8 leading-relaxed">
        この利用規約（以下「本規約」といいます。）は、TobojoLabs（個人事業主・代表 沖山敦樹。以下「当事業者」といいます。）が提供するマッチング＋決済プラットフォーム（以下「本サービス」といいます。）の利用条件を定めるものです。
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          <li>本規約は、本サービスの提供条件および利用に関する当事業者とユーザーとの間の一切の関係に適用されます。</li>
          <li>当事業者が本サービス上に掲載する個別規定・ガイドライン等（プライバシーポリシーを含む。）は本規約の一部を構成します。</li>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          <li>本サービスの利用を希望する方は、本規約に同意のうえ、当事業者の定める方法により利用登録を申請するものとします。</li>
          <li>当事業者は、以下のいずれかに該当する場合、利用登録の申請を承認しないことができ、その理由については開示義務を負いません。
            <ul className="list-disc pl-5 mt-1 space-y-1 text-gray-700">
              <li>虚偽の情報を届け出た場合</li>
              <li>過去に本規約違反等により利用停止措置を受けたことがある場合</li>
              <li>その他、当事業者が利用登録を相当でないと判断した場合</li>
            </ul>
          </li>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          ...
          <li>ID・パスワードの管理不十分により生じた損害の責任はユーザーが負い、当事業者は責任を負いません。</li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm text-gray-800 leading-relaxed">
          ...
          <li>犯罪行為に関連する行為</li>
          <li>他のユーザー、第三者または当事業者の権利・名誉・プライバシー・信用等を侵害する行為</li>
          <li>虚偽の情報を掲載する行為（他人へのなりすまし、経歴詐称を含む）</li>
          <li>本サービスの決済経路を回避して当事者間で直接取引を行い、当事業者のプラットフォーム手数料を免れる行為</li>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          ...
          <li>支払われた案件代金は、当事業者が指定する決済事業者を通じて一時的に保管され、アーティストによる納品および依頼主による検収完了後にアーティストへ送金されます（以下「検収後支払い」といいます。）。</li>
          <li>検収完了後 7 日を経過しても紛争がない場合、当事業者は当該案件代金をアーティストへ自動送金します。依頼主が上記期間内に手動で送金確定を行うこともできます。</li>
          <li>プラットフォーム手数料は案件代金の 7% とし、案件代金から控除した残額をアーティストに送金します。ただし、受注アーティストが PRO 会員である場合は 5% に減額します（依頼主の支払総額は変わらず、差 2% はアーティスト受取に加算されます）。</li>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          ...
          <li>納品物の内容や品質について当事者間で争いが生じた場合、当事業者は必要に応じて仲介を行いますが、最終的な解決は当事者間の協議によるものとします。</li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          <li>本サービスに関する著作権・商標権その他の知的財産権は、当事業者または正当な権利者に帰属します。</li>
          <li>ユーザーが本サービスに投稿したコンテンツ（プロフィール文、ポートフォリオ、メッセージ等）の著作権は投稿者に帰属します。ユーザーは当事業者に対して、本サービスの提供・運営・宣伝に必要な範囲で当該コンテンツを無償・非独占的に利用する権利を許諾するものとします。</li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          <li>当事業者は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティ等に関する欠陥、エラーやバグ、権利侵害等）がないことを明示的にも黙示的にも保証しません。</li>
          <li>当事業者は、本サービスに起因してユーザーに生じたあらゆる損害について、当事業者の故意または重過失による場合を除き、責任を負いません。</li>
          <li>当事業者は、本サービスを通じて成立した案件の内容・履行・成果物の品質については責任を負わず、当事者間の責任において解決するものとします。</li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-800 leading-relaxed">
          <li>当事業者は、以下のいずれかに該当する場合、ユーザーに事前通知することなく本サービスの提供を中断できます。
            <ul className="list-disc pl-5 mt-1 space-y-1 text-gray-700">
              <li>本サービスに係るシステムの保守・点検・更新を行う場合</li>
              <li>地震、落雷、火災、停電、天災、通信回線の事故等により提供が困難となった場合</li>
              <li>その他、当事業者が中断を必要と判断した場合</li>
            </ul>
          </li>
          <li>当事業者は、事前告知のうえ本サービスの内容を変更または提供を終了することがあります。</li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-800 leading-relaxed">
          当事業者は、必要と判断した場合、ユーザーに通知のうえ本規約を変更できます。変更後の規約は、当事業者が本サービス上に掲示した時点から効力を生じます。
        </p>
      </section>
